...
// unguarded in another place, it seems safer to define global only for this module
    ...
    jQuery.extend({
                      ...
                      expando: "jQuery" + (
                               version + Math.random()
                      ).replace(/\D/g, ""), // Assume jQuery is ready without the ready module
        ...
        (
            function (window) {
                var i, support, Expr, getText, isXML, tokenize, compile, select, outermostContext,
                    sortInput, hasDuplicate, // Local document vars
                    setDocument, document, docElem, documentIsHTML, rbuggyQSA, rbuggyMatches,
                    matches, contains, // Instance-specific data
                    ...
                    hasOwn = (
                        {}
                    ).hasOwnProperty, arr = [], pop = arr.pop, push_native = arr.push,
                    push = arr.push,
                    ...
                    funescape = function (_, escaped, escapedWhitespace) {
                        ...
                        return high !== high || escapedWhitespace ? escaped : high
                            ...
                            String.fromCharCode(high
                                                + 0x10000) : // Supplemental Plane codepoint (surrogate pair)
...
// Optimize for push.apply( _, NodeList )
                ...
                function siblingCheck(a, b) {
                    var cur = b && a,
                        diff = cur && a.nodeType === 1 && b.nodeType === 1 && a.sourceIndex
                               - b.sourceIndex;
                        ...
                        if ("form" in elem) {
                            ...
                            if (elem.parentNode && elem.disabled === false) {
                                ...
                                return elem.isDisabled === disabled
                                       ...
                                       /* jshint -W018 */
                                       elem.isDisabled !== !disabled && inDisabledFieldset(elem)
                                       === disabled;
                            }
                            return elem.disabled === disabled;
...
// Expose support vars for convenience
                ...
                isXML = Sizzle.isXML = function (elem) {
                    var namespace = elem.namespaceURI, docElem = (
                    ...
                    sortOrder = hasCompare ? function (a, b) {
                        ...
                        if (!aup || !bup) {
                            return a === document ? -1 : b
                                                         === document ? 1 : aup ? -1 : bup ? 1 : sortInput ? (
                                indexOf(sortInput, a) - indexOf(sortInput, b)
                            ) : 0;
                                        ...
                                        if (forward && useCache) {
                                            ...
                                            if (diff === false) {
                                                ...
                                                while ((
                                                    ...
                                                    if ((
                                                            ofType ? node.nodeName.toLowerCase()
                                                                     === name : node.nodeType === 1
                                                        ) && ++diff) {
                    ...
                    pseudos: {
                        ...
                        "lang": markFunction(function (lang) {
                            ...
                            return function (elem) {
                                ...
                                do {
                                    if ((
                                        elemLang = documentIsHTML ? elem.lang : elem.getAttribute(
...
// Easy API for creating new setFilters
                ...
                select = Sizzle.select = function (selector, context, results, seed) {
                    ...
                    if (match.length === 1) {
                        ...
                        if (tokens.length > 2 && (
                                              token = tokens[0]
                                          ).type === "ID" && context.nodeType === 9 && documentIsHTML
                        ...
                        while (i--) {
                            ...
                            if ((
                                ...
                                if ((
                                    seed = find(token.matches[0].replace(runescape, funescape),
...
// Implement the identical functionality for filter and not
    ...
    jQuery.fn.extend({
            ...
            return !!winnow(
                ...
                && rneedsContext.test(selector) ? jQuery(selector) : selector || [],
                false
            ).length;
        }
                     });
    ...
    var rootjQuery, // A simple way to check for HTML strings
        ...
        init = jQuery.fn.init = function (selector, context, root) {
            ...
            if (typeof selector === "string") {
                ...
                return root.ready
                       !== undefined ? root.ready(selector) : // Execute immediately if ready is not present
                    selector(jQuery);
            }
    ...
    jQuery.extend({
                      Deferred: function (func) {
                          var tuples = [// action, add listener, callbacks,
                                  ...
                                  ["notify", "progress", jQuery.Callbacks("memory"), jQuery.Callbacks(
                                      "memory"), 2], ["resolve", "done", jQuery.Callbacks("once memory"), jQuery.Callbacks(
                                  "once memory"), 0, "resolved"], ["reject", "fail", jQuery.Callbacks(
                              ...
                              state = "pending", promise = {
                                  ...
                                  pipe: function ( /* fnDone, fnFail, fnProgress */) {
                                      ...
                                      return jQuery.Deferred(function (newDefer) {
                                          ...
                                          tuples[0][3].add(resolve(0,
                                                                   newDefer,
                                                                   isFunction(onProgress) ? onProgress : Identity,
                                                                   newDefer.notifyWith
                                          ));
                                          // fulfilled_handlers.add( ... )
                                          tuples[1][3].add(resolve(0,
                                                                   newDefer,
 ...
 */
    jQuery.event = {
        ...
        remove: function (elem, types, handler, selector, mappedTypes) {
            var j, origCount, tmp, events, t, handleObj, special, handlers, type, namespaces,
                origType, elemData = dataPriv.hasData(elem) && dataPriv.get(elem);
            if (!elemData || !(
                events = elemData.events
            )) {
                return;
            ...
            load: {
                ...
                _default: function (event) {
                    ...
                    return rcheckableType.test(target.type) && target.click && nodeName(
                        target,
                        "input"
    ...
    jQuery.fn.extend({
            ...
            if (types && types.preventDefault && types.handleObj) {
                ...
                jQuery(types.delegateTarget)
                    .off(handleObj.namespace ? handleObj.origType + "."
            ...
            if (first || ignored) {
                ...
                if (hasScripts) {
                    ...
                    for (i = 0; i < hasScripts; i++) {
                        node = scripts[i];
                        if (rscriptType.test(node.type || "") && !dataPriv.access(
                            node,
                            "globalEval"
...
// Return a potentially-mapped jQuery.cssProps or vendor prefixed property
    ...
    function getWidthOrHeight(elem, dimension, extra) {
        ...
        var styles = getStyles(elem), // To avoid forcing a reflow, only fetch boxSizing if we need it (gh-4322).
            ...
            isBorderBox = boxSizingNeeded && jQuery.css(elem, "boxSizing", false, styles)
        ...
        if ((
                !support.boxSizingReliable() && isBorderBox || val === "auto" || !parseFloat(val)
        ...
        jQuery.cssHooks[dimension] = {
            get: function (elem, computed, extra) {
                ...
                var matches,
                    ...
                    scrollboxSizeBuggy = !support.scrollboxSize() && styles.position
                                         === "absolute", // To avoid forcing a reflow, only fetch boxSizing if we need it (gh-3991)
                    boxSizingNeeded = scrollboxSizeBuggy || extra,
                    isBorderBox = boxSizingNeeded && jQuery.css(elem, "boxSizing", false, styles)
                                  === "border-box", subtract = extra ? boxModelAdjustment(elem,
                                                                                          dimension,
                                                                                          extra,
                                                                                          isBorderBox,
                                                                                          styles
                ...
                if (isBorderBox && scrollboxSizeBuggy) {
                    subtract -= Math.ceil(elem["offset" + dimension[0].toUpperCase()
                                               + dimension.slice(1)] - parseFloat(styles[dimension])
                                          - boxModelAdjustment(
                            elem,
                            dimension,
                            "border",
    ...
    function Animation(elem, properties, options) {
        var result, stopped, index = 0, length = Animation.prefilters.length,
            deferred = jQuery.Deferred()
                ...
                var currentTime = fxNow || createFxNow(), remaining = Math.max(
                    0,
    ...
    jQuery.extend({
            ...
            tabIndex: {
                get: function (elem) {
                    ...
                    if (rfocusable.test(elem.nodeName) || rclickable.test(elem.nodeName)
                        && elem.href) {
                        return 0;
                    }
                    return -1;
                          ...
                          option: {
                              ...
                              get: function (elem) {
                                  var value, option, i, options = elem.options,
                                      index = elem.selectedIndex, one = elem.type === "select-one",
                                      values = one ? null : [],
                                  ...
                                  var optionSet, option, options = elem.options,
                                      values = jQuery.makeArray(value), i = options.length;
                                  while (i--) {
                                      option = options[i];
                                      /* eslint-disable no-cond-assign */
                                      if (option.selected = jQuery.inArray(jQuery.valHooks.option.get(
                                          option), values) > -1) {
                                          optionSet = true;
                                      }
                ...
                return elements ? jQuery.makeArray(elements) : this;
                       ...
                       .filter(function () {
                           ...
                           return this.name && !jQuery(this)
                                                .is(":disabled") && rsubmittable.test(this.nodeName)
                            ...
                            return access(this, function (elem, type, value) {
                                ...
                                if (isWindow(elem)) {
                                    ...
                                    return funcName.indexOf("outer") === 0 ? elem["inner"
                                                                                  + name] : elem.document.documentElement["client"
                                                                                                                          + name];
                                }
