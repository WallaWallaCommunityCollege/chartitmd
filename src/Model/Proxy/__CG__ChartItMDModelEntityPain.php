 ...
 */
class Pain extends \ChartItMD\Model\Entity\Pain implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ChartItMD\\Model\\Entity\\Pain' . "\0" . 'measurement', '' . "\0" . 'ChartItMD\\Model\\Entity\\Pain' . "\0" . 'createdAt', '' . "\0" . 'ChartItMD\\Model\\Entity\\Pain' . "\0" . 'createdBy', '' . "\0" . 'ChartItMD\\Model\\Entity\\Pain' . "\0" . 'id', '' . "\0" . 'ChartItMD\\Model\\Entity\\Pain' . "\0" . 'location', '' . "\0" . 'ChartItMD\\Model\\Entity\\Pain' . "\0" . 'measuredIn', '' . "\0" . 'ChartItMD\\Model\\Entity\\Pain' . "\0" . 'measurementLimits', '' . "\0" . 'ChartItMD\\Model\\Entity\\Pain' . "\0" . 'methodUsed', '' . "\0" . 'ChartItMD\\Model\\Entity\\Pain' . "\0" . 'patient'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pain $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setMeasurementLimits(?\ChartItMD\Model\Entity\MeasurementLimits $value): \ChartItMD\Model\Entity\Pain
    {
