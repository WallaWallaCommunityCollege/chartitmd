 ...
 */
class Height extends \ChartItMD\Model\Entity\Height implements \Doctrine\ORM\Proxy\Proxy {
    /**
    ...
    public function __sleep() {
        if ($this->__isInitialized__) {
            return [
                '__isInitialized__',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Height' . "\0" . 'height',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Height' . "\0" . 'measuredIn',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Height' . "\0" . 'patient',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Height' . "\0" . 'createdAt',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Height' . "\0" . 'createdBy',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Height' . "\0" . 'id',
            ];
        }
        return [
            '__isInitialized__',
     ...
     * {@inheritDoc}
     */
    public function setMeasuredIn(?\ChartItMD\Model\Entity\UnitOfMeasurement $value): \ChartItMD\Model\Entity\Height {
