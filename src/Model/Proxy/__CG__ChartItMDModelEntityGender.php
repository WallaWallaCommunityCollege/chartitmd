...
class Gender extends \ChartItMD\Model\Entity\Gender implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ChartItMD\\Model\\Entity\\Gender' . "\0" . 'assignedSex', '' . "\0" . 'ChartItMD\\Model\\Entity\\Gender' . "\0" . 'identity', '' . "\0" . 'ChartItMD\\Model\\Entity\\Gender' . "\0" . 'pronoun', '' . "\0" . 'ChartItMD\\Model\\Entity\\Gender' . "\0" . 'createdAt', '' . "\0" . 'ChartItMD\\Model\\Entity\\Gender' . "\0" . 'createdBy', '' . "\0" . 'ChartItMD\\Model\\Entity\\Gender' . "\0" . 'id'];
        }
