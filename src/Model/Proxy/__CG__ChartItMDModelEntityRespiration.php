...
class Respiration extends \ChartItMD\Model\Entity\Respiration implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ChartItMD\\Model\\Entity\\Respiration' . "\0" . 'measurement', '' . "\0" . 'ChartItMD\\Model\\Entity\\Respiration' . "\0" . 'createdAt', '' . "\0" . 'ChartItMD\\Model\\Entity\\Respiration' . "\0" . 'createdBy', '' . "\0" . 'ChartItMD\\Model\\Entity\\Respiration' . "\0" . 'id', '' . "\0" . 'ChartItMD\\Model\\Entity\\Respiration' . "\0" . 'location', '' . "\0" . 'ChartItMD\\Model\\Entity\\Respiration' . "\0" . 'measuredIn', '' . "\0" . 'ChartItMD\\Model\\Entity\\Respiration' . "\0" . 'measurementLimits', '' . "\0" . 'ChartItMD\\Model\\Entity\\Respiration' . "\0" . 'methodUsed', '' . "\0" . 'ChartItMD\\Model\\Entity\\Respiration' . "\0" . 'patient'];
        }
     ...
     * {@inheritDoc}
     */
    public function setMeasuredIn(?\ChartItMD\Model\Entity\UnitOfMeasurement $value): \ChartItMD\Model\Entity\Respiration
    {
     ...
     * {@inheritDoc}
     */
    public function setMeasurementLimits(?\ChartItMD\Model\Entity\MeasurementLimits $value): \ChartItMD\Model\Entity\Respiration
    {
