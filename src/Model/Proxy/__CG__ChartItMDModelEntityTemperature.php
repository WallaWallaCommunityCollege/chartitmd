...
class Temperature extends \ChartItMD\Model\Entity\Temperature implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ChartItMD\\Model\\Entity\\Temperature' . "\0" . 'temperature', '' . "\0" . 'ChartItMD\\Model\\Entity\\Temperature' . "\0" . 'createdAt', '' . "\0" . 'ChartItMD\\Model\\Entity\\Temperature' . "\0" . 'createdBy', '' . "\0" . 'ChartItMD\\Model\\Entity\\Temperature' . "\0" . 'id', '' . "\0" . 'ChartItMD\\Model\\Entity\\Temperature' . "\0" . 'location', '' . "\0" . 'ChartItMD\\Model\\Entity\\Temperature' . "\0" . 'measuredIn', '' . "\0" . 'ChartItMD\\Model\\Entity\\Temperature' . "\0" . 'methodUsed', '' . "\0" . 'ChartItMD\\Model\\Entity\\Temperature' . "\0" . 'patient'];
        }
     ...
     * {@inheritDoc}
     */
    public function setMeasuredIn(?\ChartItMD\Model\Entity\UnitOfMeasurement $value): \ChartItMD\Model\Entity\Temperature
    {
