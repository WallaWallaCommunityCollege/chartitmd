...
class Diastolic extends \ChartItMD\Model\Entity\Diastolic implements \Doctrine\ORM\Proxy\Proxy {
    ...
    public function __sleep() {
        if ($this->__isInitialized__) {
            return [
                '__isInitialized__',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'measurement',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'createdAt',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'createdBy',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'id',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'location',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'measuredIn',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'methodUsed',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'patient',
            ];
        }
        return [
            '__isInitialized__',
    ...
    ): \ChartItMD\Model\Entity\Diastolic {
