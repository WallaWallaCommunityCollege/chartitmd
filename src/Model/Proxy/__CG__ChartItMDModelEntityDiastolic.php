 ...
 */
class Diastolic extends \ChartItMD\Model\Entity\Diastolic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'measurement', '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'createdAt', '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'createdBy', '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'id', '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'location', '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'measuredIn', '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'measurementLimits', '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'methodUsed', '' . "\0" . 'ChartItMD\\Model\\Entity\\Diastolic' . "\0" . 'patient'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Diastolic $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setLocation(?\ChartItMD\Model\Entity\Location $value): \ChartItMD\Model\Entity\Diastolic
    {
     ...
     * {@inheritDoc}
     */
    public function setMeasuredIn(?\ChartItMD\Model\Entity\UnitOfMeasurement $value): \ChartItMD\Model\Entity\Diastolic
    {
     ...
     * {@inheritDoc}
     */
    public function setMeasurementLimits(?\ChartItMD\Model\Entity\MeasurementLimits $value): \ChartItMD\Model\Entity\Diastolic
    {
     ...
     * {@inheritDoc}
     */
    public function setMethodUsed(?\ChartItMD\Model\Entity\Method $value): \ChartItMD\Model\Entity\Diastolic
    {
