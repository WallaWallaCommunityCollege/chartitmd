...
class Location extends \ChartItMD\Model\Entity\Location implements \Doctrine\ORM\Proxy\Proxy {
    ...
    public function __sleep() {
        if ($this->__isInitialized__) {
            return [
                '__isInitialized__',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Location' . "\0" . 'abbreviation',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Location' . "\0" . 'description',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Location' . "\0" . 'name',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Location' . "\0" . 'createdAt',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Location' . "\0" . 'createdBy',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Location' . "\0" . 'id',
            ];
        }
        return [
            '__isInitialized__',
