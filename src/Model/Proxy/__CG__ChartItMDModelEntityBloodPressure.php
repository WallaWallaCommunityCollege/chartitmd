...
class BloodPressure extends \ChartItMD\Model\Entity\BloodPressure implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ChartItMD\\Model\\Entity\\BloodPressure' . "\0" . 'diastolic', '' . "\0" . 'ChartItMD\\Model\\Entity\\BloodPressure' . "\0" . 'locationUsed', '' . "\0" . 'ChartItMD\\Model\\Entity\\BloodPressure' . "\0" . 'measuredIn', '' . "\0" . 'ChartItMD\\Model\\Entity\\BloodPressure' . "\0" . 'methodUsed', '' . "\0" . 'ChartItMD\\Model\\Entity\\BloodPressure' . "\0" . 'patient', '' . "\0" . 'ChartItMD\\Model\\Entity\\BloodPressure' . "\0" . 'systolic', '' . "\0" . 'ChartItMD\\Model\\Entity\\BloodPressure' . "\0" . 'createdAt', '' . "\0" . 'ChartItMD\\Model\\Entity\\BloodPressure' . "\0" . 'createdBy', '' . "\0" . 'ChartItMD\\Model\\Entity\\BloodPressure' . "\0" . 'id'];
        }
