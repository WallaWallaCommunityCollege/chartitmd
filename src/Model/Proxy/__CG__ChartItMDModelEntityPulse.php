...
class Pulse extends \ChartItMD\Model\Entity\Pulse implements \Doctrine\ORM\Proxy\Proxy {
    ...
    public function __sleep() {
        if ($this->__isInitialized__) {
            return [
                '__isInitialized__',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Pulse' . "\0" . 'rate',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Pulse' . "\0" . 'createdAt',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Pulse' . "\0" . 'createdBy',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Pulse' . "\0" . 'id',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Pulse' . "\0" . 'location',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Pulse' . "\0" . 'measuredIn',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Pulse' . "\0" . 'methodUsed',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Pulse' . "\0" . 'patient',
            ];
        }
        return [
            '__isInitialized__',
