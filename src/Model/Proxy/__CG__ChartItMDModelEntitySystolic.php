...
class Systolic extends \ChartItMD\Model\Entity\Systolic implements \Doctrine\ORM\Proxy\Proxy {
    ...
    public function __sleep() {
        if ($this->__isInitialized__) {
            return [
                '__isInitialized__',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Systolic' . "\0" . 'measurement',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Systolic' . "\0" . 'createdAt',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Systolic' . "\0" . 'createdBy',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Systolic' . "\0" . 'id',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Systolic' . "\0" . 'location',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Systolic' . "\0" . 'measuredIn',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Systolic' . "\0" . 'methodUsed',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\Systolic' . "\0" . 'patient',
            ];
        }
        return [
            '__isInitialized__',
