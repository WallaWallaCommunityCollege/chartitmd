 ...
 */
class RolePermission extends \ChartItMD\Model\Entity\RolePermission implements \Doctrine\ORM\Proxy\Proxy {
    /**
    ...
    public function __sleep() {
        if ($this->__isInitialized__) {
            return [
                '__isInitialized__',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\RolePermission' . "\0" . 'createdAt',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\RolePermission' . "\0" . 'createdBy',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\RolePermission' . "\0" . 'permission',
                '' . "\0" . 'ChartItMD\\Model\\Entity\\RolePermission' . "\0" . 'role',
            ];
        }
        return [
            '__isInitialized__',
