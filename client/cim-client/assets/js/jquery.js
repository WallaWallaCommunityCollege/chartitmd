        ...
        (
            function (window) {
                var i, support, Expr, getText, isXML, tokenize, compile, select, outermostContext, sortInput,
                    ...
                    hasOwn = (
                        {}
                    ).hasOwnProperty, arr = [], pop = arr.pop, push_native = arr.push, push = arr.push,
			...
			*/
                        ...
                        "lang": markFunction(function (lang) {
                            ...
                            return function (elem) {
                                ...
                                do {
                                    if ((
                                        elemLang = documentIsHTML ? elem.lang : elem.getAttribute("xml:lang")
...
// Easy API for creating new setFilters
                ...
                function matcherFromTokens(tokens) {
                    var checkContext, matcher, j, len = tokens.length, leadingRelative = Expr.relative[tokens[0].type],
                        implicitRelative = leadingRelative || Expr.relative[" "], i = leadingRelative
                                                                                      ? 1
                                                                                      : 0, // The foundational matcher ensures that elements are reachable from top-level context(s)
                        matchContext = addCombinator(function (elem) {
                            ...
                            function (elem, context, xml) {
                                var ret = (
                                              ...
                                              ).nodeType ? matchContext(elem, context, xml) : matchAnyContext(
                                                  elem,
                                                  context,
                                                  xml
                                              )
 ...
 */
    jQuery.event = {
        ...
        remove: function (elem, types, handler, selector, mappedTypes) {
            ...
            var i, j, ret, matched, handleObj, handlerQueue, args = new Array(arguments.length), handlers = (
                                                                                                            dataPriv.get(
                                                                                                                this,
                                                                                                                "events"
                                                                                                            ) || {}
...
// a vendor prefixed property.
    ...
    jQuery.cssHooks.marginLeft = addGetHookIf(support.reliableMarginLeft, function (elem, computed) {
        if (computed) {
            return (
                       parseFloat(curCSS(elem, "marginLeft")) || elem.getBoundingClientRect().left - swap(elem,
                                                                                                          {marginLeft: 0},
                                                                                                          function () {
                          ...
                          option: {
                              ...
                              get: function (elem) {
                                  ...
                                  while (i--) {
                                      ...
                                      if (option.selected = jQuery.inArray(jQuery.valHooks.option.get(option), values)
                                                            > -1) {
                                          optionSet = true;
                                      }
                ...
                return elements ? jQuery.makeArray(elements) : this;
                       ...
                       .filter(function () {
                           ...
                           return this.name && !jQuery(this)
                               .is(":disabled") && rsubmittable.test(this.nodeName) && !rsubmitterTypes.test(type) && (
...
// Detect, normalize options and install callbacks for jsonp requests
    jQuery.ajaxPrefilter("json jsonp", function (s, originalSettings, jqXHR) {
        var callbackName, overwritten, responseContainer, jsonProp = s.jsonp !== false && (
            rjsonp.test(s.url) ? "url" : typeof s.data
                                                                     === "string"
                                                                     && (
                                                                         s.contentType || ""
                                                                     )
