...
const appMenu = [{
    ...
    label: 'Patient', submenu: [{
        label: 'Home', click() {
            win.loadURL(url.format({
                                       pathname: path.join(__dirname, 'patient.html'), protocol: 'file:', slashes: true
                                   }));
        }
    }, {type: 'separator'}, {
    ...
    label: 'Admin', submenu: [{
        label: 'Browse Users', click() {
            win.loadURL(url.format({
                                       pathname: path.join(__dirname, 'users.html'), protocol: 'file:', slashes: true
                                   }));
        }
    },]
}, {
    label: 'Help', submenu: [{
        label: 'About', click() {
            ...
            about.loadURL(url.format({
                                         pathname: path.join(__dirname, 'about.html'), protocol: 'file:', slashes: true
                                     }));
        }
    }]
}];
