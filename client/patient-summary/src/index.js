...
TODO: get the data from the patient and write the summary with said information
      Dont use hard-coded values.
      To get previous appointment, use a for loop to get all appointments, and compare each appointment date
      with each iteration.
...
//Functions
function test() {
    window.confirm("I passed the test");
}
